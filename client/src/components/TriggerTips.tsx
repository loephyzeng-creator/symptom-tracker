...
export const DEFAULT_TRIGGER_TIPS: TriggerTipData[] = [
  {
    ...
    recommended: [
      "金银花枸杞决明子菊花茶", "菊花枸杞茶", "金银花甘草茶", "绿豆汤", "莲子心茶", "陈皮水", "淡竹叶茶",
      "蜂蜜柠檬温水", "铁皮石斛猴头菇", "苦瓜", "黄瓜", "冬瓜", "莲藕", "梨", "西瓜", "百合银耳",
    ],
    avoid: ["辛辣食物", "油炸煎烤", "羊肉", "荔枝", "龙眼", "榴莲", "浓茶咖啡", "酒精"],
    tip: "多喝温水，饮食清淡，规律作息。金银花枸杞决明子菊花茶清热明目且不过于寒凉，菊花枸杞茶清热且温补，陈皮水理气健脾。铁皮石斛猴头菇滋阴养胃，适合上火但脾胃较弱的情况。薄荷水虽有清利头目的作用，但性寒凉，脾胃虚寒或容易拉肚子的人应少喝或避免，可用淡竹叶茶替代。如症状持续请咨询医生。",
  },
  {
    trigger: "睡眠不足",
    icon: Moon,
